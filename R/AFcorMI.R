...
#' @rdname AFcorMI
#' @name AFcorMI
#' @title Prediction of Weighted Mutual Information Adjacency Matrix by
#' Correlation
#' @description
...
#' unsigned. The prediction corresponds to the \code{AdjacencyUniversalVersion2}
#' discussed in the help file for  the function
#' \code{\link{mutualInfoAdjacency}}. For more information about the generation
#' and features of the predicted mutual information adjacency, please refer to
#' the function \code{\link{mutualInfoAdjacency}}.
#' @return
#' A matrix with the same size as the input correlation matrix, containing the
#' predicted mutual information of type \code{AdjacencyUniversalVersion2}.
#' @author
