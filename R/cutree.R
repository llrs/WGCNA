...
#' \code{\link{standardColors}} to convert the retuned numerical lables into
#' colors for easier visualization or \code{\link{cutreeStaticColor}}.
#' @keywords misc
#' @examples
#' 
...
#' @author Peter Langfelder
#' @seealso for hierarchical clustering: \code{\link[stats]{hclust}} , for for
#' other constant-height branch cuts\code{\link[stats]{cutree}} and
